...
export const eventAPI = {
  ...
  getEvent: (id, config = {}) => api.get(`/users/events/${encodeURIComponent(id)}/`, config),
  getEventTickets: (id, params = {}) => api.get(`/users/events/${encodeURIComponent(id)}/tickets/`, { params }),

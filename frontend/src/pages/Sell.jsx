        ...
        <form id="sell-listing-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="terms-checkbox-container sell-single-compliance">
            <label className="terms-checkbox-label">
              ...
              />
              <span>
                אני מצהיר/ה שהכרטיס לא נמכר ולא יימכר באף פלטפורמה אחרת. במידה ואמכור אותו מחוץ לאתר,
                באחריותי להיכנס ולהסיר אותו מידית. ידוע לי שמכירה כפולה תוביל לביטול התשלום ולחיוב על עמלות.
              </span>
            </label>
          </div>

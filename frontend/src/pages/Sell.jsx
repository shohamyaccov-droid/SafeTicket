...
const Sell = () => {
  ...
  const missingEventWhatsAppHref = `https://wa.me/${WHATSAPP_SUPPORT_PHONE}?text=${encodeURIComponent(
    'היי SafeTrade, אני רוצה למכור כרטיס לאירוע שלא קיים באתר — נא לפרט: שם אמן/קבוצות, תאריך, אולם/עיר.'
  )}`;
    ...
    return (
      <div className="sell-container">
        <div className="listing-card success-message">
          ...
          <p className="success-text">הכרטיס שלך נשלח לאימות על ידי צוות SafeTrade ויעלה לאוויר מיד לאחר האישור.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="terms-checkbox-container">
            ...
            <label htmlFor="acceptedTerms" className="terms-checkbox-label">
              אני מסכים/ה לתנאי השימוש של SafeTrade ומאשר/ת שהתשלום בגין המכירה יועבר אליי כ-24 שעות לאחר קיום האירוע, על מנת להבטיח קנייה בטוחה ואת אמינות הכרטיסים.
            </label>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="event-request-modal-lead">
                נתאר בקצרה את האירוע החסר. צוות SafeTrade יעדכן את הקטלוג כשהפרטים מאומתים.
              </p>

...
const Dashboard = () => {
  ...
  const handleAcceptOffer = async (offerId) => {
    ...
    try {
      ...
      setToast({
        message: 'ההצעה אושרה בהצלחה! הודעה נשלחה לקונה, ויש לו 24 שעות להשלים את הרכישה.',
        type: 'success'
      });
    } catch (err) {
                            ...
                            {(purchase.final_negotiated_price != null || purchase.buyer_service_fee != null) && (
                              <>
                                ...
                                {purchase.buyer_service_fee != null && Number(purchase.buyer_service_fee) > 0 && (
                                  <div className="detail-row">
                                    <span className="detail-label">דמי שירות ותפעול:</span>

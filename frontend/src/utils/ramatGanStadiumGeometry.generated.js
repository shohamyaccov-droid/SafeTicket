...
export const RAMAT_GAN_STADIUM_SECTIONS_BASE = [
  ...
  { id: '9A', label: '9A', path: 'M350 310.5H477.5V409H418.5L350 342V310.5Z', status: 'unavailable' },
  { id: '9B', label: '9B', path: 'M479.5 255.5C514.833 255.167 587.1 254.7 593.5 255.5V189.5H479.5V255.5Z', status: 'unavailable' },
  ...
  { id: '13A', label: '13A', path: 'M825.5 473.5H673V416.5H825.5V473.5Z', status: 'unavailable' },
  ...
  { id: 'A1', label: 'A1', path: 'M215 222L280 189.5L286 258.5L264.5 273L215 222Z', status: 'unavailable' },
  { id: 'B4', label: 'B4', path: 'M258.5 540.5V473.5L406 479.5L310.5 578L258.5 540.5Z', status: 'unavailable' },
  { id: 'B5', label: 'B5', path: 'M351 600.5L427.5 506V600.5H351Z', status: 'unavailable' },
  { id: 'B6', label: 'B6', path: 'M665.526 406H603V315H735L665.526 406Z', status: 'unavailable' },
  { id: 'C7', label: 'C7', path: 'M767.809 572L674 480.357L826 474L767.809 572Z', status: 'unavailable' },
  { id: 'C8', label: 'C8', path: 'M745 326.5L676 411H827.5L745 326.5Z', status: 'unavailable' },
  { id: 'C9', label: 'C9', path: 'M948.5 310.5L903 363.5L898 389H974L968 332L948.5 310.5Z', status: 'unavailable' },

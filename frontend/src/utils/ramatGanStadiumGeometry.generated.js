...
export const RAMAT_GAN_STADIUM_SECTIONS_BASE = [
  ...
  { id: '11A', label: '11A', path: 'M479.5 255.5C514.833 255.167 587.1 254.7 593.5 255.5V189.5H479.5V255.5Z', status: 'unavailable' },
  ...
  { id: '9A', label: '9A', path: 'M293 190.5H378.5V255.5H293V190.5Z', status: 'unavailable' },
  { id: 'D14', label: 'D14', path: 'M351 600.5L427.5 506V600.5H351Z', status: 'unavailable' },
  { id: 'D13', label: 'D13', path: 'M435 601V505.369L493.033 501L495 601H435Z', status: 'unavailable' },

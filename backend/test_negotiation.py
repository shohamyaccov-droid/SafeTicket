...
class NegotiationE2ETest(TestCase):
    ...
    def test_complete_negotiation_flow(self):
        ...
        print(f"[OK] Ticket ID: {self.ticket.id}, Price: 200 ILS")
        ...
        print(f"[OK] Created offer ID {offer_1_id} for 100 ILS")
        ...
        print(f"[OK] Created counter-offer ID {counter_id} for 150 ILS")
        ...
        print("[OK] Original offer marked as countered")

        # perform_create blocks duplicate round-0 offers within 5s for the same buyer/ticket
        time.sleep(5.1)
        ...
        print(f"[OK] Created offer ID {offer_2_id} for 120 ILS")
        ...
        print(f"[OK] Accepted offer ID {offer_2_id}")
        ...
        print("[OK] Other pending offers automatically rejected")
        ...
        print("[OK] Buyer can see accepted offer with complete-purchase action available")
        
        # Step 7: Verify public listing price is still 200 ILS
        print("\nSTEP 7: Verify public listing price unchanged (200 ILS)")
        self.ticket.refresh_from_db()
        self.assertEqual(float(self.ticket.asking_price), 200.00)
        print("[OK] Public listing still shows 200 ILS for other users")
        ...
        print("[OK] Checkout will use negotiated price: 120 ILS")
        print(f"[OK] Checkout window expires at: {offer_details['checkout_expires_at']}")
        ...
        print("\n[OK] Bid/Ask Negotiation System is working correctly!")

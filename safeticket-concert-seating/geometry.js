/**
 * SafeTicket concert seating — magnified Bloomfield-style bowl (orthogonal grid).
 * Coordinate space: 2000×1280 (2× legacy 1000×640) so the chart scales cleanly on large screens.
 * Block sizes: W ≈ 1.8× prior cell width, H ≈ 2× prior cell height; gaps/aisles scaled for balance.
 */

export const VIEW_W = 2000;
export const VIEW_H = 1280;

/** Magnified cell (prior art ~58×44 → ×1.8 / ×2.0) */
...
/** Scaled lateral aisle: center floor ↔ wing */
const AISLE_SIDE = 52;
/** Scaled gap: row C ↔ back row */
const AISLE_BACK = 36;
/** Wing stack ↔ top of 80A */
...
/**
 * Background “zones” as orthogonal outlines (styled as frames in Map.css).
 * West slab, East slab, South ring, Center stage + pitch ring.
 */
